...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    ...
    const filterConfigs = [
        ...
        { name: 'reportId', label: 'Report ID', icon: FilterIcons.reportId, placeholder: 'Select Report ID' },
        { name: 'reportName', label: 'Report Name', icon: FilterIcons.reportName, placeholder: 'Select Report Name' },
        { name: 'approvalStatus', label: 'Approval Status', icon: FilterIcons.approvalStatus, placeholder: 'Select Status' },
    ];
