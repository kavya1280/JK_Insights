...
const KPICards = ({ kpis }) => {
    ...
    const stats = {
        ...
        totalDuplicateReports: kpis?.total_duplicate_reports || 0,
        totalDuplicateAmount: kpis?.total_duplicate_amount || 0,
        employeesWithDuplicates: kpis?.employees_with_duplicates || 0,
        maxDuplicates: kpis?.max_duplicates || 0
    };
    ...
    const cards = [
        { label: 'Distinct Employee ID', value: stats.distinctEmployeeId, type: 'number', icon: Icons.employeeId, color: '#6FAE2C' },
        { label: 'Employee Name', value: stats.distinctEmployeeName, type: 'number', icon: Icons.employee, color: '#0B4F94' },
        { label: 'Duplicate Reports', value: stats.totalDuplicateReports, type: 'number', icon: Icons.status, color: '#EF5350' },
        { label: 'Amount in Duplicates', value: stats.totalDuplicateAmount, type: 'currency', icon: Icons.currency, color: '#EF5350' },
        { label: 'Employees with Duplicates', value: stats.employeesWithDuplicates, type: 'number', icon: Icons.employee, color: '#6FAE2C' },
        { label: 'Max Duplicates on Report', value: stats.maxDuplicates, type: 'number', icon: Icons.status, color: '#0B4F94' }
    ];
