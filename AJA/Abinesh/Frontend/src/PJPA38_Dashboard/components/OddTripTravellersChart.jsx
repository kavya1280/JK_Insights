...
const OddTripTravellersChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    ...
                    <p className="tooltip-value">{payload[0].value.toLocaleString()} Odd Trips</p>
                </div>
            );
        }
        return null;
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Odd Trip Travellers (Top 15)</h3>
            </div>
...
export default OddTripTravellersChart;
