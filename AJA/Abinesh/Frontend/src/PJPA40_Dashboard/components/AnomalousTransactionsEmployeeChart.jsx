...
const AnomalousTransactionsEmployeeChart = ({ data }) => {
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Anomalous Transactions by Employee</h3>
            </div>
...
export default AnomalousTransactionsEmployeeChart;
