...
const GhostEmployeeNoticeChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    <p className="tooltip-label">Notice: {payload[0].payload.notice_bucket}</p>
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Ghost Employees by Notice Period</h3>
            </div>
            <div className="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 5 }} barCategoryGap="30%">
                        ...
                        <XAxis dataKey="notice_bucket" stroke="#9E9E9E" tick={{ fontSize: 11 }} axisLine={false} tickLine={false} />
...
export default GhostEmployeeNoticeChart;
