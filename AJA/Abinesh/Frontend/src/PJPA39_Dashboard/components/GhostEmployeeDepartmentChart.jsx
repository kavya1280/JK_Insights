...
const GhostEmployeeDepartmentChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    <p className="tooltip-label">{payload[0].payload.department}</p>
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Ghost Employees by Department</h3>
            </div>
            <div className="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} layout="vertical" margin={{ top: 10, right: 30, left: 60, bottom: 5 }} barCategoryGap="20%">
                        ...
                        <YAxis type="category" dataKey="department" stroke="#9E9E9E" tick={{ fontSize: 11 }} axisLine={false} tickLine={false} width={80} />
...
export default GhostEmployeeDepartmentChart;
