...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    const uniqueValues = {
        ...
        notice_bucket: options?.notice_buckets || [],
        cost_center: options?.cost_centers || [],
    ...
    const filterConfigs = [
        ...
        { name: 'department', label: 'Department', icon: FilterIcons.department, placeholder: 'All' },
        { name: 'notice_bucket', label: 'Notice Bucket', icon: FilterIcons.notice, placeholder: 'All' },
        { name: 'cost_center', label: 'Cost Center', icon: FilterIcons.costCenter, placeholder: 'All' },
    ...
    return (
        <div className="filters-section">
            ...
            <div className="filters-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(180px, 1fr))', gap: '20px', marginTop: '20px' }}>
