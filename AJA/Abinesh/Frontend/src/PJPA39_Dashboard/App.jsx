...
const API = 'http://localhost:8000/api/pjpa39';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', department: '', notice_bucket: '', cost_center: '', employee_status: '', search: ''
    });
        ...
        <div className="dashboard pjpa39-dashboard">
            ...
            <div className="dashboard-content">
                ...
                <div className="charts-grid">
                    ...
                    <GhostEmployeeStatusChart data={charts?.ghost_employee_status || []} />
                    <GhostEmployeeTrendChart data={charts?.ghost_employee_trend || []} />
                    <GhostEmployeeCostCenterChart data={charts?.ghost_employee_cost_center || []} />
                </div>
