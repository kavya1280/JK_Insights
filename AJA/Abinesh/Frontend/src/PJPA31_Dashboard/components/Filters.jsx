...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    ...
    const filterConfigs = [
        { name: 'employeeName', label: 'Employee Name', icon: FilterIcons.employeeName, placeholder: 'Select Name' },
        { name: 'department', label: 'Department', icon: FilterIcons.department, placeholder: 'Select Department' },
        { name: 'reportId', label: 'Trip ID / Report Id', icon: FilterIcons.reportId, placeholder: 'Select Trip ID' },
        { name: 'riskCategory', label: 'Risk Category', icon: FilterIcons.riskCategory, placeholder: 'Select Risk' },
    ];
