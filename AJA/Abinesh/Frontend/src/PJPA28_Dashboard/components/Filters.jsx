...
const FilterIcons = {
    ...
    report: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>),
...
const handleScreenshot = async () => {
    try {
        ...
        link.download = `pjpa28_benfords_${new Date().toISOString().slice(0, 10)}.png`;
...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    const uniqueValues = {
        ...
        approval_status: options?.approval_statuses || [],
    ...
    const filterConfigs = [
        ...
        { name: 'report_id', label: 'Report ID', icon: FilterIcons.report, placeholder: 'All' },
        { name: 'approval_status', label: 'Approval Status', icon: FilterIcons.status, placeholder: 'All' },
