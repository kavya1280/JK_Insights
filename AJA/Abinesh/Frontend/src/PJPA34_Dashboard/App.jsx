...
import TransactionDateTrendChart from './components/TransactionDateTrendChart';
import BusinessPurposeChart from './components/BusinessPurposeChart';

import '../PJPA 32 dashboard/src/index.css';

const API = 'http://localhost:8000/api/pjpa34';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', employee: '', expense_type: '', payment_type: '', search: ''
    });
        ...
        <div className="dashboard pjpa34-dashboard">
            ...
            <div className="dashboard-content">
                ...
                <div className="charts-grid">
                    <EmployeeClaimCountChart data={charts?.claim_count_by_employee || []} />
                    <EmployeeTotalAmountChart data={charts?.total_amount_by_employee || []} />
                    <ExpenseTypeChart data={charts?.claims_by_expense_type || []} />
                    <PaymentTypeChart data={charts?.claims_by_payment_type || []} />
                    <TransactionDateTrendChart data={charts?.claims_trend_date || []} />
                    <BusinessPurposeChart data={charts?.business_purpose_freq || []} />
                </div>
