...
const BusinessPurposeChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    <p className="tooltip-label">{payload[0].payload.purpose}</p>
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Business Purpose Frequency</h3>
            </div>
            <div className="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} layout="vertical" margin={{ top: 10, right: 30, left: 100, bottom: 5 }} barCategoryGap="20%">
                        ...
                        <YAxis type="category" dataKey="purpose" stroke="#9E9E9E" tick={{ fontSize: 11 }} axisLine={false} tickLine={false} width={120} />
...
export default BusinessPurposeChart;
