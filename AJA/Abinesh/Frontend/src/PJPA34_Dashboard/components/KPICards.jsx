...
const KPICards = ({ kpis }) => {
    ...
    const stats = {
        ...
        distinctPaymentType: kpis?.distinct_payment_type || 0
    };
    ...
    const cards = [
        ...
        { label: 'Total Claims', value: stats.distinctReportId, type: 'number', icon: Icons.status, color: '#6FAE2C' },
        { label: 'Total Amount', value: stats.totalReportAmount, type: 'currency', icon: Icons.currency, color: '#0B4F94' },
        { label: 'Expense Types', value: stats.distinctExpenseType, type: 'number', icon: Icons.status, color: '#6FAE2C' },
        { label: 'Payment Types', value: stats.distinctPaymentType, type: 'number', icon: Icons.status, color: '#0B4F94' }
    ];
