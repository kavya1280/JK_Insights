...
import {
  ...
  remove,
  removeFirst
} from "./chunk-P2BTZTZE.js";
import {
  area_default,
  cardinal_default,
  line_default,
  stepAfter
} from "./chunk-NTZOO4F2.js";
...
var XYChartScrollbar = class extends Scrollbar {
  constructor() {
    super(...arguments);
    this.chart = this.children.push(XYChart.new(this._root, {
      themeTags: ["chart"],
      interactive: false,
    ...
    this.overlay = this.children.push(Graphics.new(this._root, {
      themeTags: ["overlay"],
      interactive: false
    }));
  }
...
XYChartScrollbar.className = "XYChartScrollbar";
XYChartScrollbar.classNames = Scrollbar.classNames.concat([XYChartScrollbar.className]);
        ...
        if (field != void 0) {
          ...
          if (baseAxis == xAxis2) {
            ...
            if (realField) {
              ...
              point3 = this._yRenderer.positionToPoint(positionY);
              y = point3.y;
              x = left + w * locationX;
            }
          } else {
            ...
            if (realField) {
              ...
              point3 = this._xRenderer.positionToPoint(positionX);
              x = point3.x;
...
var DateAxis = class extends ValueAxis {
  ...
  roundAxisPosition(position, location) {
    ...
    if (!isNaN(value)) {
      ...
      if (timezone) {
        value = roun(value + this._baseDuration * 0.05, timeUnit, count, this._root, this.getPrivate("min", 0));
...
GaplessDateAxis.className = "GaplessDateAxis";
GaplessDateAxis.classNames = DateAxis.classNames.concat([GaplessDateAxis.className]);
...
DurationAxis.className = "DurationAxis";
DurationAxis.classNames = ValueAxis.classNames.concat([DurationAxis.className]);
...
AxisBullet.className = "AxisBullet";
AxisBullet.classNames = Entity.classNames.concat([AxisBullet.className]);
...
EditableAxisLabel.className = "EditableAxisLabel";
EditableAxisLabel.classNames = EditableLabel.classNames.concat([EditableAxisLabel.className]);
...
Candlestick.classNames = RoundedRectangle.classNames.concat([Candlestick.className]);
...
var ColumnSeries = class extends BaseColumnSeries {
  ...
  _updateChildren() {
    if (this.isDirty("turboMode")) {
      ...
      if (!this.get("turboMode")) {
        this.allColumns.set("draw", void 0);
      }
    }
    super._updateChildren();
  }
...
var CandlestickSeries = class extends ColumnSeries {
  constructor() {
    super(...arguments);
    this.columns = this.addDisposer(new ListTemplate(Template.new({
      themeTags: ["autocolor"]
...
CandlestickSeries.classNames = ColumnSeries.classNames.concat([CandlestickSeries.className]);
...
OHLC.className = "OHLC";
OHLC.classNames = Candlestick.classNames.concat([OHLC.className]);
...
OHLCSeries.classNames = CandlestickSeries.classNames.concat([OHLCSeries.className]);
...
SmoothedYLineSeries.className = "SmoothedYLineSeries";
SmoothedYLineSeries.classNames = LineSeries.classNames.concat([SmoothedYLineSeries.className]);
...
SmoothedXYLineSeries.className = "SmoothedXYLineSeries";
SmoothedXYLineSeries.classNames = LineSeries.classNames.concat([SmoothedXYLineSeries.className]);
