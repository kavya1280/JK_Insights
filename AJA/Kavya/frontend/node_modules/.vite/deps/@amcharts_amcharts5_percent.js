...
FunnelSlice.className = "FunnelSlice";
FunnelSlice.classNames = Graphics.classNames.concat([FunnelSlice.className]);
...
var FunnelSeries = class extends PercentSeries {
  constructor() {
    super(...arguments);
    this._tag = "funnel";
    this.links = this.addDisposer(this._makeLinks());
    this._total = 0;
    this._count = 0;
    this._nextCoord = 0;
...
FunnelSeries.classNames = PercentSeries.classNames.concat([FunnelSeries.className]);
...
PyramidSeries.classNames = FunnelSeries.classNames.concat([PyramidSeries.className]);
