...
export class Treemap extends Hierarchy {
    constructor() {
        super(...arguments);
        this._tag = "treemap";
        this.rectangleTemplate = Template.new({});
        this._treemapLayout = d3hierarchy.treemap().tile(d3hierarchy.treemapSquarify);
        /**
         * A list of node rectangle elements in a [[Treemap]] chart.
         *
         * @default new ListTemplate<RoundedRectangle>
         */
        this.rectangles = this.addDisposer(new ListTemplate(Template.new({}), () => RoundedRectangle._new(this._root, {
...
Treemap.classNames = Hierarchy.classNames.concat([Treemap.className]);
