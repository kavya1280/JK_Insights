...
const API = 'http://localhost:5000/api/pjpa33';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        ...
        payment_status: '', search: '', startDate: '', endDate: ''
    });
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.employee, filters.report_id, filters.approval_status, filters.payment_status, filters.startDate, filters.endDate, debouncedSearch]);
