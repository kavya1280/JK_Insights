...
const AmountByPolicyChart = ({ data }) => {
    const chartData = useMemo(() => {
        ...
        data.forEach(item => {
            ...
            map.set(policy, (map.get(policy) || 0) + amount);
        });
    ...
    return (
        <div className="chart-card chart-animate equal-height-card">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Amount Approved by Policy</h3>
            </div>
            ...
            <div style={{ textAlign: 'center', color: '#9E9E9E', fontSize: '12px', marginTop: '10px' }}>Compare spending policy categories</div>
        </div>
    );
};

export default AmountByPolicyChart;
