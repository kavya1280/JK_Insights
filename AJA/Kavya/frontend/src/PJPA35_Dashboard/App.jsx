...
import PolicyAmountPieChart from './components/PolicyAmountPieChart';
import EmployeeAmountChart from './components/EmployeeAmountChart';
import AmountSpentByDateChart from './components/AmountSpentByDateChart';
import EmployeeCountByPolicyChart from './components/EmployeeCountByPolicyChart';

import '../PJPA 32 dashboard/src/index.css';

const API = 'http://localhost:5000/api/pjpa35';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', report_id: '', approval_status: '', payment_status: '', search: '', startDate: '', endDate: ''
    });
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.report_id, filters.approval_status, filters.payment_status, filters.startDate, filters.endDate, debouncedSearch]);
        ...
        <div className="dashboard pjpa35-dashboard">
            ...
            <div className="dashboard-content">
                ...
                <div className="charts-grid">
                    <PolicyAmountPieChart data={charts?.policy_amount_approved || []} />
                    <EmployeeAmountChart data={charts?.amount_spent_employee || []} />
                    <AmountSpentByDateChart data={charts?.amount_spent_date || []} />
                    <EmployeeCountByPolicyChart data={charts?.employee_count_policy || []} />
                </div>
