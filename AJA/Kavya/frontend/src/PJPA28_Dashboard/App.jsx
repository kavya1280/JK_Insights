...
import BenfordBarChart from './components/BenfordBarChart';
import ZScoreChart from './components/ZScoreChart';
import AnomalyBarChart from './components/AnomalyBarChart';
import ClaimsByPolicyChart from './components/ClaimsByPolicyChart';
import ReportTotalVsApprovedChart from './components/ReportTotalVsApprovedChart';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', report_id: '', approval_status: '',
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.report_id, filters.approval_status, filters.payment_status, debouncedSearch]);
    ...
    if (initialLoading) {
        return (
            <div className="dashboard-loading">
                ...
                <p>Initializing Benford's Law Analysis dashboard...</p>
            </div>
        );
    }
    ...
    return (
        <div className="dashboard pjpa28-dashboard">
            ...
            <div className="dashboard-content">
                ...
                <div className="charts-grid">
                    <BenfordBarChart data={charts?.first_digit || []} title="1st Digit: Actual vs Expected %" digitLabel="Digit" />
                    <BenfordBarChart data={charts?.second_digit || []} title="2nd Digit: Actual vs Expected %" digitLabel="Digit" />
                    <ZScoreChart data={charts?.first_two_digit_zscore || []} />
                    <AnomalyBarChart data={charts?.anomalies_by_employee || []} />
                    <ClaimsByPolicyChart data={charts?.claims_by_policy || []} />
                    <ReportTotalVsApprovedChart data={charts?.report_total_vs_approved || []} />
                </div>
