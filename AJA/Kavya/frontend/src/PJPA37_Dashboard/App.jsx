...
const API = 'http://localhost:5000/api/pjpa37';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', report_id: '', cluster_id: '', is_anomaly: '', startDate: '', endDate: '', search: ''
    });
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.report_id, filters.cluster_id, filters.is_anomaly, filters.startDate, filters.endDate, debouncedSearch]);
