...
const FilterIcons = {
    ...
    reportId: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z" /><polyline points="14 2 14 8 20 8" /></svg>),
    clusterId: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"></path><polyline points="3.27 6.96 12 12.01 20.73 6.96"></polyline><line x1="12" y1="22.08" x2="12" y2="12"></line></svg>),
    anomaly: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z" /><line x1="12" y1="9" x2="12" y2="13" /><line x1="12" y1="17" x2="12.01" y2="17" /></svg>)
};
...
const handleScreenshot = async () => {
    try {
        ...
        link.download = `pjpa37_dashboard_${new Date().toISOString().slice(0, 10)}.png`;
...
const SearchableDropdown = ({ label, icon, placeholder, options, value, onChange }) => {
    ...
    const displayValue = value === "1" ? "Yes" : (value === "0" ? "No" : value);
...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    const uniqueValues = {
        ...
        cluster_id: options?.cluster_ids || [],
        is_anomaly: options?.is_anomaly_options || []
    };
    ...
    const filterConfigs = [
        ...
        { name: 'report_id', label: 'Report ID', icon: FilterIcons.reportId, placeholder: 'All' },
        { name: 'cluster_id', label: 'Cluster ID', icon: FilterIcons.clusterId, placeholder: 'All' },
        { name: 'is_anomaly', label: 'Is Anomaly', icon: FilterIcons.anomaly, placeholder: 'All' }
    ];
