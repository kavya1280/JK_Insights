...
const API = 'http://localhost:5000/api/pjpa40';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', expense_type: '', policy: '', report_id: '', search: ''
    });
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.expense_type, filters.policy, filters.report_id, debouncedSearch]);
    ...
    if (initialLoading) {
        return (
            <div className="dashboard-loading">
                ...
                <p>Initializing Backdated Transaction Analysis dashboard...</p>
            </div>
        );
    }
