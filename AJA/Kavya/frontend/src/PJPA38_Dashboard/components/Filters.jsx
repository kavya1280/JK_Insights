...
const FilterIcons = {
    employee: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><rect x="2" y="5" width="20" height="14" rx="2" /><line x1="2" y1="10" x2="22" y2="10" /></svg>),
    ...
    expenseType: (<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="1" x2="12" y2="23" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>)
};
...
const handleScreenshot = async () => {
    try {
        ...
        link.download = `pjpa38_dashboard_${new Date().toISOString().slice(0, 10)}.png`;
...
const Filters = ({ options, filters, onFilterChange, onReset }) => {
    ...
    const filterConfigs = [
        { name: 'employee_id', label: 'Employee ID', icon: FilterIcons.employee, placeholder: 'All' },
        { name: 'report_id', label: 'Report ID', icon: FilterIcons.reportId, placeholder: 'All' },
        { name: 'expense_type', label: 'Mode of Transport', icon: FilterIcons.expenseType, placeholder: 'All' }
    ];
