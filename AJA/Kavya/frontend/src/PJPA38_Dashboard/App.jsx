...
import OddModeFrequencyChart from './components/OddModeFrequencyChart';
import SpendOddModesPieChart from './components/SpendOddModesPieChart';
import TopEmployeesOddModesChart from './components/TopEmployeesOddModesChart';
import AvgSpendOddModeChart from './components/AvgSpendOddModeChart';

import '../PJPA 32 dashboard/src/index.css';

const API = 'http://localhost:5000/api/pjpa38';
...
function App({ onBack }) {
    ...
    const [filters, setFilters] = useState({
        employee_id: '', report_id: '', expense_type: '', startDate: '', endDate: '', search: ''
    });
    ...
    useEffect(() => {
        ...
        fetchAll();
    }, [filters.employee_id, filters.report_id, filters.expense_type, filters.startDate, filters.endDate, debouncedSearch]);
        ...
        <div className="dashboard pjpa38-dashboard">
            ...
            <div className="dashboard-content">
                ...
                <div className="charts-grid">
                    <OddModeFrequencyChart data={charts?.odd_mode_freq || []} />
                    <SpendOddModesPieChart data={charts?.spend_odd_modes || []} />
                    <TopEmployeesOddModesChart data={charts?.top_employees_odd || []} />
                    <AvgSpendOddModeChart data={charts?.avg_spend_odd_mode || []} />
                </div>
