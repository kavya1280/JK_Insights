...
const ReportIDClaimMapChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    <p className="tooltip-label">Report: {payload[0].payload.report_id}</p>
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Report ID Claim Map</h3>
            </div>
            <div className="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} margin={{ top: 20, right: 30, left: 20, bottom: 60 }}>
                        <CartesianGrid strokeDasharray="3 3" stroke="#F4F6F8" vertical={false} />
                        <XAxis dataKey="report_id" angle={-45} textAnchor="end" interval={0} tick={{ fontSize: 10, fill: '#666' }} height={60} axisLine={false} tickLine={false} />
...
export default ReportIDClaimMapChart;
