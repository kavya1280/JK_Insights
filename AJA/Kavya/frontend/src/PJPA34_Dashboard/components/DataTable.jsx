...
const PREFERRED = [
    ...
    { key: 'Year', label: 'Year' },
    { key: 'Month (Name)', label: 'Month' },
    { key: 'Total Amount Approved', label: 'Total Amount Approved', isAmount: true },
    { key: 'Count(Report Id)', label: 'Count(Report ID)' },
    { key: 'Average of Amount Approved', label: 'Avg Amount Approved', isAmount: true },
    ...
    { key: 'Submit_Date2', label: 'Submit Date' }
];
