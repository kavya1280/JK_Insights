...
const AverageClaimAmountByEmployeeChart = ({ data }) => {
        ...
        if (active && payload && payload.length) {
            return (
                <div className="custom-tooltip">
                    ...
                    <p className="tooltip-value">{RS}{payload[0].value.toLocaleString()} (Avg)</p>
                </div>
            );
        }
        return null;
    ...
    return (
        <div className="chart-card chart-animate">
            <div className="chart-title-row">
                ...
                <h3 className="chart-title">Average Claim Amount by Employee</h3>
            </div>
            <div className="chart-container">
                <ResponsiveContainer width="100%" height="100%">
                    <BarChart data={data} layout="vertical" margin={{ top: 10, right: 30, left: 60, bottom: 5 }} barCategoryGap="20%">
                        ...
                        <Bar dataKey="avg_amount" radius={[0, 6, 6, 0]} isAnimationActive animationDuration={1200}>
...
export default AverageClaimAmountByEmployeeChart;
